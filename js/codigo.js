...
document.addEventListener('DOMContentLoaded', function(){
    document.getElementById('admPeliculas').addEventListener('submit', function(event){
        ...
        if (txtTitulo === ''){
            mostrarMensajeError('titulError', 'El campo no puede estar vacío');
            isValid = false;
        }
        if (txtFecEstreno === ''){
            mostrarMensajeError('fechaestrenoError', 'El campo no puede estar vacio');
            isValid = false;
        }
        if (txtGenero === ''){
        ...
        if (txtReparto === ''){
            mostrarMensajeError('repartoError', 'El campom no puede estar vacío');
            isValid = false;
        }
        if (txtSinopsis === ''){
